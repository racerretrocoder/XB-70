...
print("Unique ID: ");
 print(unique);
    ...
    if(tid == 0) { # where not given a typeID
                        ...
                        if(me.NameOfMissile == "Aim-54"){me.NameOfMissile="Aim-54";typeID = 55;me.isradarmissile = 1;}
                        if(me.NameOfMissile == "B61"){me.NameOfMissile="B61";typeID = 98;me.isradarmissile = 0;}
                        ...
                        if(me.NameOfMissile == "Aim-47"){me.NameOfMissile="Aim-47";typeID = 2;me.isradarmissile = 2;}    
...
broddamage: func (cs,dist,msl) {
    ...
    if(msl == "Aim-47"){msl="Aim-47";typeID = 2;}    
            ...
            if(! v)
            {
                ...
                print("booom he ded like a brick (missile hit target successfully!)");
                    ...
                    var typeID = 0;
                        ...
                        if(me.NameOfMissile == "Aim-54"){me.NameOfMissile="Aim-54";typeID = 55;}
                        if(me.NameOfMissile == "B61"){me.NameOfMissile="B61";typeID = 98;}
                        ...
                        if(me.NameOfMissile == "Aim-47"){me.NameOfMissile="Aim-47";typeID = 2;}    
